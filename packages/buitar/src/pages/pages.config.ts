...
export const pagesIntroConfig = new Map<string, PageIntroType>([
	...
	[
		'ChordCollections',
		{
			title: '你的和弦都在这里',
			content: [
				'我们当然希望你熟练所有的和弦与转换，不过忘却与记忆是人之常态，所以我们提供了一个收藏夹，让你可以随时回顾。你可以在每一个指法卡片上新增你的收藏。',
				'当前也提供了一些基于Caged系统的简单指法默认收藏，可以随意拖动改变这些指法的品位范围。',
			],
		},
	],
	[
	...
	[
		'Instrument',
		{
			...
			content: [
				...
				'键盘左侧使用「 Z X C V B N M 」行键盘作为白键，「 S D F H J 」行作为黑键，同理右侧使用「 Y U I O P [ ] 」行作为白键，「 8 9 0 - = 」数字行作为黑键，表示C2 & C3音，使用 shift 切换为 C4 & C5',
			],
		},
	],
	[
